---
name: ganger:update
description: Update Ganger skills to the latest version from GitHub. Use when the user runs "ganger update", "update ganger", "pull latest ganger", or wants to get the newest Ganger skills.
---
